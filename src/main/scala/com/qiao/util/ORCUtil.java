...
public class ORCUtil{
	...
	public String getData(String key) {
		...
		return com.qiao.util.Utils.isEmpty(values) || values.toLowerCase().equals("null") ? null : values;
	}
	...
	public ORCUtil addAttr(Object... objs){
		if(com.qiao.util.Utils.isEmpty(list)){
	...
	public Writable serialize(){
		if(com.qiao.util.Utils.isEmpty(serde)){
			serde = new OrcSerde();
		}
